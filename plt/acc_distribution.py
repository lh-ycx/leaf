...
if __name__ == "__main__":
    ...
    with open('{}/celeba/clients_info_celeba_no_trace_5.cfg.json'.format(log_dir), 'r') as f:
        client2acc = json.load(f)
        data_3 = defaultdict(int)
        for key in client2acc:
            data_3[str(client2acc[key]['acc'])] += 1
    with open('{}/celeba/clients_info_celeba_trace_5.cfg.json'.format(log_dir), 'r') as f:
        client2acc = json.load(f)
